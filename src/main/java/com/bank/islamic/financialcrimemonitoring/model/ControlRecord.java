package com.bank.islamic.financialcrimemonitoring.model;
...
/**
 * The BIAN control record for this service domain: "Financial Crime Alert Monitoring State".
 *
 ...
 * to its asset type (Financial Crime Alert). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Financial Crime Alert Monitoring State";
